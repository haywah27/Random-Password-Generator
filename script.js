...
// Write password to the #password input from the generate password function
...
function generatePassword(){
  ...
  for (var i = 0; i < lengthPass; i++){
    // newPass.push posts to empty array // math to pick random positions in user decided arrays
